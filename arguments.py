...
def get_argument_parser():
    ...
    parser.add_argument('--no_entitiesnorm', action='store_true',
                        help='Do not normalize the imgcap embeddings.')
    ...
    parser.add_argument('--bert_path', type=str, default='bert-base-uncased',
                        help='the path of bert pretrained checkpoint')
    ...
    parser.add_argument('--loss_type', default='trip', type=str, help='the type of loss function')

    parser.add_argument('--save_fold5', type=bool, default=False, help='whether to save coco 1k checkpoints')
    ...
    parser.add_argument('--entities_learing_rate', default=.0002, type=float,
                        help='inversed temperature of softmax in scan coding.')
    return parser
